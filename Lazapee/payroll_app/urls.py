...
urlpatterns = [
    ...
    path('employee/delete/<str:id_number>/', views.delete_employee, name='delete_employee'),
    path('employee/overtime/<str:id_number>/', views.add_overtime, name='add_overtime'),
]